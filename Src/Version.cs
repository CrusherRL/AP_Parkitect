...
namespace ArchipelagoMod.Src
{
    class Version
    {
        private static readonly Dictionary<string, string[]> SupportedVersions = new Dictionary<string, string[]>
        {
            ...
            { "1.4.1", new[] { "v1.2.1", "v1.3.0", "v1.3.3", "v1.4.0", "v1.4.1" } },
            { "1.5.0", new[] { "v1.2.1", "v1.3.0", "v1.3.3", "v1.4.0", "v1.4.1", "v1.5.0" } },
            { "1.6.0", new[] { "v1.2.1", "v1.3.0", "v1.3.3", "v1.4.0", "v1.4.1", "v1.5.0", "v1.6.0", "v1.6.1" } },
            { "1.6.1", new[] { "v1.2.1", "v1.3.0", "v1.3.3", "v1.4.0", "v1.4.1", "v1.5.0", "v1.6.0", "v1.6.1" } },
            { "1.6.2", new[] { "v1.2.1", "v1.3.0", "v1.3.3", "v1.4.0", "v1.4.1", "v1.5.0", "v1.6.0", "v1.6.1" } },
        };

        public string ap_world_version = null;

        public Version(string ap_world_version = null)
        {
        ...
        public string[] Messages()
        {
            ...
            return new[] { $"Your AP World version is not compatible with this mod!\nAP World version: {this.ap_world_version}\nMod version: {Constants.VERSION}\n", $"Supported Versions: [{this.GetSupportedVersions()}]" };
        }

        public string GetSupportedVersions()
        {
            return Helper.SerializeText(SupportedVersions[Constants.VERSION]);
        }
